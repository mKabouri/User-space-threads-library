...
typedef struct signal {
  int id;
  void (*signal_handler)(int signal_id,struct thread *target_thread);
...
/* Initialiser un signal */
int signal_init(signal_t *signal, int id);

/* Détruire un signal */
int signal_destroy(signal_t *signal);

/* Envoyer un signal au thread courant (sommet de la queue) */
int signal_send(signal_t *signal, thread_t *target_thread);

/* Attendre la réception d'un signal */
int signal_wait(signal_t *signal);
